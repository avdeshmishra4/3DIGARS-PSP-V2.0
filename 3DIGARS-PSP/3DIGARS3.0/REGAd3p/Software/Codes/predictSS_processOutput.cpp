...
int main(int argc, char *argv[])
{
	...
	strcat(svm_predict_command, rank);
	...
	strcat(prediction_output_file_name, rank);
	...
	strcat(prediction_output_file_name_procss, rank);
